...
COMMENT ON COLUMN "tin"."asset_etf"."rebalancing_dates" IS 'Даты ребалансировок.';
...
COMMENT ON COLUMN "tin"."get_last_prices_request"."figi" IS 'Deprecated Figi-идентификатор инструмента. Необходимо использовать instrument_id.';
COMMENT ON COLUMN "tin"."get_last_prices_request"."instrument_id" IS 'Массив идентификаторов инструмента, принимает значения figi или instrument_uid.';
...
CREATE TABLE IF NOT EXISTS "tin"."asset_instrument" (
	...
	"ticker" text NOT NULL,
	"class_code" text NOT NULL,
	"links_type" text NULL,
	"links_instrument_uid" text NULL,
...
COMMENT ON COLUMN "tin"."asset_instrument"."links_type" IS 'Массив связанных инструментов. / Тип связи.';
COMMENT ON COLUMN "tin"."asset_instrument"."links_instrument_uid" IS 'Массив связанных инструментов. / uid идентификатор связанного инструмента.';
...
CREATE TABLE IF NOT EXISTS "tin"."get_candles_request" (
	...
	CONSTRAINT "get_candles_request_interval_id_fk" FOREIGN KEY ("interval_id") REFERENCES "tin"."candle_interval" ("id")
);
CREATE INDEX IF NOT EXISTS "get_candles_request_interval_id_idx" ON "tin"."get_candles_request" USING btree ("interval_id");
...
CREATE TABLE IF NOT EXISTS "tin"."get_trading_status_response" (
	...
	CONSTRAINT "get_trading_status_response_trading_status_id_fk" FOREIGN KEY ("trading_status_id") REFERENCES "tin"."security_trading_status" ("id")
);
CREATE INDEX IF NOT EXISTS "get_trading_status_response_trading_status_id_idx" ON "tin"."get_trading_status_response" USING btree ("trading_status_id");
...
CREATE TABLE IF NOT EXISTS "tin"."instrument_request" (
	...
	CONSTRAINT "instrument_request_id_type_id_fk" FOREIGN KEY ("id_type_id") REFERENCES "tin"."instrument_id_type" ("id")
);
CREATE INDEX IF NOT EXISTS "instrument_request_id_type_id_idx" ON "tin"."instrument_request" USING btree ("id_type_id");
...
CREATE TABLE IF NOT EXISTS "tin"."operations_request" (
	...
	CONSTRAINT "operations_request_state_id_fk" FOREIGN KEY ("state_id") REFERENCES "tin"."operation_state" ("id")
);
CREATE INDEX IF NOT EXISTS "operations_request_state_id_idx" ON "tin"."operations_request" USING btree ("state_id");
...
CREATE TABLE IF NOT EXISTS "tin"."asset" (
	...
	CONSTRAINT "asset_instruments_id_fk" FOREIGN KEY ("instruments_id") REFERENCES "tin"."asset_instrument" ("uid")
);
...
CREATE TABLE IF NOT EXISTS "tin"."order_trades" (
	...
	CONSTRAINT "order_trades_trades_id_fk" FOREIGN KEY ("trades_id") REFERENCES "tin"."order_trade" ("trade_id")
);
CREATE INDEX IF NOT EXISTS "order_trades_direction_id_idx" ON "tin"."order_trades" USING btree ("direction_id");
CREATE INDEX IF NOT EXISTS "order_trades_trades_id_idx" ON "tin"."order_trades" USING btree ("trades_id");
...
COMMENT ON COLUMN "tin"."order_trades"."trades_id" IS 'Массив сделок.';
...
CREATE TABLE IF NOT EXISTS "tin"."post_order_request" (
	...
	CONSTRAINT "post_order_request_direction_id_fk" FOREIGN KEY ("direction_id") REFERENCES "tin"."order_direction" ("id"),
	CONSTRAINT "post_order_request_order_type_id_fk" FOREIGN KEY ("order_type_id") REFERENCES "tin"."order_type" ("id")
);
CREATE INDEX IF NOT EXISTS "post_order_request_direction_id_idx" ON "tin"."post_order_request" USING btree ("direction_id");
CREATE INDEX IF NOT EXISTS "post_order_request_order_type_id_idx" ON "tin"."post_order_request" USING btree ("order_type_id");
...
CREATE TABLE IF NOT EXISTS "tin"."asset_full" (
	...
	CONSTRAINT "asset_full_instruments_id_fk" FOREIGN KEY ("instruments_id") REFERENCES "tin"."asset_instrument" ("uid")
);
...
CREATE INDEX IF NOT EXISTS "asset_full_instruments_id_idx" ON "tin"."asset_full" USING btree ("instruments_id");
...
COMMENT ON COLUMN "tin"."asset_full"."required_tests" IS 'Тестирование клиентов.';
...
COMMENT ON COLUMN "tin"."asset_full"."instruments_id" IS 'Массив идентификаторов инструментов.';
...
CREATE TABLE IF NOT EXISTS "tin"."operation" (
	...
	CONSTRAINT "operation_trades_id_fk" FOREIGN KEY ("trades_id") REFERENCES "tin"."operation_trade" ("trade_id")
);
...
CREATE TABLE IF NOT EXISTS "tin"."post_order_response" (
	...
	CONSTRAINT "post_order_response_execution_report_status_id_fk" FOREIGN KEY ("execution_report_status_id") REFERENCES "tin"."order_execution_report_status" ("id"),
	CONSTRAINT "post_order_response_direction_id_fk" FOREIGN KEY ("direction_id") REFERENCES "tin"."order_direction" ("id"),
	CONSTRAINT "post_order_response_order_type_id_fk" FOREIGN KEY ("order_type_id") REFERENCES "tin"."order_type" ("id")
);
CREATE INDEX IF NOT EXISTS "post_order_response_execution_report_status_id_idx" ON "tin"."post_order_response" USING btree ("execution_report_status_id");
CREATE INDEX IF NOT EXISTS "post_order_response_direction_id_idx" ON "tin"."post_order_response" USING btree ("direction_id");
CREATE INDEX IF NOT EXISTS "post_order_response_order_type_id_idx" ON "tin"."post_order_response" USING btree ("order_type_id");
...
CREATE TABLE IF NOT EXISTS "tin"."post_stop_order_request" (
	...
	CONSTRAINT "post_stop_order_request_direction_id_fk" FOREIGN KEY ("direction_id") REFERENCES "tin"."stop_order_direction" ("id"),
	CONSTRAINT "post_stop_order_request_expiration_type_id_fk" FOREIGN KEY ("expiration_type_id") REFERENCES "tin"."stop_order_expiration_type" ("id"),
	CONSTRAINT "post_stop_order_request_stop_order_type_id_fk" FOREIGN KEY ("stop_order_type_id") REFERENCES "tin"."stop_order_type" ("id")
);
CREATE INDEX IF NOT EXISTS "post_stop_order_request_direction_id_idx" ON "tin"."post_stop_order_request" USING btree ("direction_id");
CREATE INDEX IF NOT EXISTS "post_stop_order_request_expiration_type_id_idx" ON "tin"."post_stop_order_request" USING btree ("expiration_type_id");
CREATE INDEX IF NOT EXISTS "post_stop_order_request_stop_order_type_id_idx" ON "tin"."post_stop_order_request" USING btree ("stop_order_type_id");
...
CREATE TABLE IF NOT EXISTS "tin"."order_state" (
	...
	CONSTRAINT "order_state_stages_id_fk" FOREIGN KEY ("stages_id") REFERENCES "tin"."order_stage" ("trade_id"),
...
CREATE INDEX IF NOT EXISTS "order_state_stages_id_idx" ON "tin"."order_state" USING btree ("stages_id");
...
COMMENT ON COLUMN "tin"."order_state"."stages_id" IS 'Стадии выполнения заявки.';
