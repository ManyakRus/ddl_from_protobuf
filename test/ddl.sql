...
CREATE TABLE IF NOT EXISTS "tin"."operation_item" (
	...
	"asset_uid" text NOT NULL,
	CONSTRAINT "operation_item_pk" PRIMARY KEY ("id"),
	CONSTRAINT "operation_item_type_id_fk" FOREIGN KEY ("type_id") REFERENCES "tin"."operation_type" ("id"),
	CONSTRAINT "operation_item_state_id_fk" FOREIGN KEY ("state_id") REFERENCES "tin"."operation_state" ("id"),
	CONSTRAINT "operation_item_instrument_kind_id_fk" FOREIGN KEY ("instrument_kind_id") REFERENCES "tin"."instrument_type" ("id")
);
CREATE INDEX IF NOT EXISTS "operation_item_type_id_idx" ON "tin"."operation_item" USING btree ("type_id");
CREATE INDEX IF NOT EXISTS "operation_item_state_id_idx" ON "tin"."operation_item" USING btree ("state_id");
CREATE INDEX IF NOT EXISTS "operation_item_instrument_kind_id_idx" ON "tin"."operation_item" USING btree ("instrument_kind_id");
COMMENT ON TABLE "tin"."operation_item" IS 'Данные об операции.';
COMMENT ON COLUMN "tin"."operation_item"."cursor" IS 'Курсор.';
COMMENT ON COLUMN "tin"."operation_item"."broker_account_id" IS 'Номер счета клиента.';
COMMENT ON COLUMN "tin"."operation_item"."id" IS 'Идентификатор операции, может меняться с течением времени.';
COMMENT ON COLUMN "tin"."operation_item"."parent_operation_id" IS 'Идентификатор родительской операции, может измениться, если изменился id родительской операции.';
COMMENT ON COLUMN "tin"."operation_item"."name" IS 'Название операции.';
COMMENT ON COLUMN "tin"."operation_item"."date" IS 'Дата поручения.';
COMMENT ON COLUMN "tin"."operation_item"."type_id" IS 'Тип операции.';
COMMENT ON COLUMN "tin"."operation_item"."description" IS 'Описание операции.';
COMMENT ON COLUMN "tin"."operation_item"."state_id" IS 'Статус поручения.';
COMMENT ON COLUMN "tin"."operation_item"."instrument_uid" IS 'Уникальный идентификатор инструмента.';
COMMENT ON COLUMN "tin"."operation_item"."figi" IS 'Figi.';
COMMENT ON COLUMN "tin"."operation_item"."instrument_type" IS 'Тип инструмента.';
COMMENT ON COLUMN "tin"."operation_item"."instrument_kind_id" IS 'Тип инструмента.';
COMMENT ON COLUMN "tin"."operation_item"."position_uid" IS 'position_uid-идентификатора инструмента.';
COMMENT ON COLUMN "tin"."operation_item"."payment_currency" IS 'Сумма операции. / строковый ISO-код валюты';
COMMENT ON COLUMN "tin"."operation_item"."payment_units" IS 'Сумма операции. / целая часть суммы, может быть отрицательным числом';
COMMENT ON COLUMN "tin"."operation_item"."payment_nano" IS 'Сумма операции. / дробная часть суммы, может быть отрицательным числом';
COMMENT ON COLUMN "tin"."operation_item"."price_currency" IS 'Цена операции за 1 инструмент. / строковый ISO-код валюты';
COMMENT ON COLUMN "tin"."operation_item"."price_units" IS 'Цена операции за 1 инструмент. / целая часть суммы, может быть отрицательным числом';
COMMENT ON COLUMN "tin"."operation_item"."price_nano" IS 'Цена операции за 1 инструмент. / дробная часть суммы, может быть отрицательным числом';
COMMENT ON COLUMN "tin"."operation_item"."commission_currency" IS 'Комиссия. / строковый ISO-код валюты';
COMMENT ON COLUMN "tin"."operation_item"."commission_units" IS 'Комиссия. / целая часть суммы, может быть отрицательным числом';
COMMENT ON COLUMN "tin"."operation_item"."commission_nano" IS 'Комиссия. / дробная часть суммы, может быть отрицательным числом';
COMMENT ON COLUMN "tin"."operation_item"."yield_currency" IS 'Доходность. / строковый ISO-код валюты';
COMMENT ON COLUMN "tin"."operation_item"."yield_units" IS 'Доходность. / целая часть суммы, может быть отрицательным числом';
COMMENT ON COLUMN "tin"."operation_item"."yield_nano" IS 'Доходность. / дробная часть суммы, может быть отрицательным числом';
COMMENT ON COLUMN "tin"."operation_item"."yield_relative_units" IS 'Относительная доходность. / целая часть суммы, может быть отрицательным числом';
COMMENT ON COLUMN "tin"."operation_item"."yield_relative_nano" IS 'Относительная доходность. / дробная часть суммы, может быть отрицательным числом';
COMMENT ON COLUMN "tin"."operation_item"."accrued_int_currency" IS 'Накопленный купонный доход. / строковый ISO-код валюты';
COMMENT ON COLUMN "tin"."operation_item"."accrued_int_units" IS 'Накопленный купонный доход. / целая часть суммы, может быть отрицательным числом';
COMMENT ON COLUMN "tin"."operation_item"."accrued_int_nano" IS 'Накопленный купонный доход. / дробная часть суммы, может быть отрицательным числом';
COMMENT ON COLUMN "tin"."operation_item"."quantity" IS 'Количество единиц инструмента.';
COMMENT ON COLUMN "tin"."operation_item"."quantity_rest" IS 'Неисполненный остаток по сделке.';
COMMENT ON COLUMN "tin"."operation_item"."quantity_done" IS 'Исполненный остаток.';
COMMENT ON COLUMN "tin"."operation_item"."cancel_date_time" IS 'Дата и время снятия заявки.';
COMMENT ON COLUMN "tin"."operation_item"."cancel_reason" IS 'Причина отмены операции.';
COMMENT ON COLUMN "tin"."operation_item"."asset_uid" IS 'Идентификатор актива';
