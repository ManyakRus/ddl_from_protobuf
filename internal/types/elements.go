...
// the enum construct in a protobuf file. MapEnums are
...
// ProtoAll is a datastructure which represents the parsed model
...
type ProtoAll struct {
	...
	//Options            []OptionElement
	MapEnums    map[string]*EnumElement
	MapMessages map[string]*MessageElement
